...
my @comments = Comment->find(
    inflate => [Comment=>'inflate_us_date_format']
);
is(@comments,10);
...
is($authors[0]->articles->[0]->comments->[0]->column('creation_date'), '2005-12-01');
is($authors[0]->articles->[0]->comments->[0]->column('creation_date_formated'), 'Dec 1,2005');
...
is($author->articles->[0]->comments->[0]->column('creation_date'), '2005-12-01');
is($author->articles->[0]->comments->[0]->column('creation_date_formated'), 'Dec 1,2005');
