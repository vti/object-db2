...
# one-to-many
is(Schema::Article->schema->relationship('comments')->foreign_class, 'Schema::Comment');
is(Schema::Article->schema->relationship('comments')->foreign_table, 'comments');
is(Schema::Article->schema->relationship('comments')->class, 'Schema::Article');



# many-to-one
is(Schema::Comment->schema->relationship('article')->foreign_class, 'Schema::Article');
is(Schema::Comment->schema->relationship('article')->foreign_table, 'articles');
is(Schema::Comment->schema->relationship('article')->class, 'Schema::Comment');
