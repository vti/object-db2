...
# ->next
for (my $i=1; $i<=$authors->row(0)->articles->row(0)->comments->number_of_rows; $i++){
...
is_deeply( \@test, ['comment 1-1-1', 'comment 1-1-2', 'comment 1-1-3', 'comment 1-1-4', 'comment 1-1-5', 'comment 1-1-6'] );
